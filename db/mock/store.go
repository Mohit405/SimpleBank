...
// Source: github.com/mohit405/simplebank/db/sqlc (interfaces: Store)
...
// CreateEntery mocks base method.
func (m *MockStore) CreateEntery(arg0 context.Context, arg1 db.CreateEnteryParams) (db.Entery, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateEntery", arg0, arg1)
	ret0, _ := ret[0].(db.Entery)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateEntery indicates an expected call of CreateEntery.
func (mr *MockStoreMockRecorder) CreateEntery(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateEntery", reflect.TypeOf((*MockStore)(nil).CreateEntery), arg0, arg1)
}
